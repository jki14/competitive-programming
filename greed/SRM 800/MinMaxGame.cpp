...
// CUT begin
ifstream data("MinMaxGame.sample");
...
bool do_test(vector<int> A, int __expected) {
    ...
    MinMaxGame *instance = new MinMaxGame();
    int __result = instance->lastNumber(A);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "MinMaxGame (400 Points)" << endl << endl;
    }
