...
// CUT begin
ifstream data("ConnectedSubgraph.sample");
...
bool do_test(int k, vector<string> __expected) {
    ...
    ConnectedSubgraph *instance = new ConnectedSubgraph();
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "ConnectedSubgraph (500 Points)" << endl << endl;
    }
