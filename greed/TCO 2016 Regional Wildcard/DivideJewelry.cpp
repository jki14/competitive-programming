...
// CUT begin
ifstream data("DivideJewelry.sample");
...
bool do_test(vector<int> x, vector<int> __expected) {
    ...
    DivideJewelry *instance = new DivideJewelry();
    vector<int> __result = instance->divide(x);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "DivideJewelry (250 Points)" << endl << endl;
    }
