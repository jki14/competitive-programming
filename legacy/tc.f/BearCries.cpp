...
class BearCries {
	...
	int count(string message){
		n=LENGTH(message);
		for(int i=0; i<n; i++)a[i]=message[i];
		...
		for(int i=0; i<n; i++){
			for(int j=0; j<=i; j++){
				for(int k=0; k<=i; k++){
					if(a[i]==';'){
						//head
						MOD_ADD(&f[i+1][j+1][k], f[i][j][k]);
						//tail
						if(k>0)
							MOD_ADD(&f[i+1][j][k-1], MOD_MUL(f[i][j][k], k));
					}else{
						//push
						if(j>0)
							MOD_ADD(&f[i+1][j-1][k+1], MOD_MUL(f[i][j][k], j));
						//conn
						if(k>0)
							MOD_ADD(&f[i+1][j][k], MOD_MUL(f[i][j][k], k));
					}
				}
			}
		}
		return MOD_STD(f[n][0][0]);
	}
...
// BEGIN CUT HERE
	...
	void test_case_0() { string Arg0 = ";_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;;_;"; int Arg1 = 793796586; verify_case(0, Arg1, count(Arg0)); }
