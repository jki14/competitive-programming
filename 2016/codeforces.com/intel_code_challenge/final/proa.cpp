...
int main() {
    ...
    map<string, int> dict;
    dict.insert(MP(string("monday"), 0));
    dict.insert(MP(string("tuesday"), 1));
    dict.insert(MP(string("wednesday"), 2));
    dict.insert(MP(string("thursday"), 3));
    dict.insert(MP(string("friday"), 4));
    dict.insert(MP(string("saturday"), 5));
    dict.insert(MP(string("sunday"), 6));
    string a, b;
    while(cin>>a>>b){
        int x=dict[a];
        int y=dict[b];
