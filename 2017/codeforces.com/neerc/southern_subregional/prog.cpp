...
int n, m, s;
int nbs[310000], nxt[610000], dst[610000], opn[610000], pos[610000], eid;
int v[310000], f[310000], r;

void add_edge(const int u, const int v, const int mir, const int rep) {
    nxt[eid]=nbs[u];
    dst[eid]=v;
    opn[eid]=mir;
    pos[eid]=rep;
...
void process(const int u, const int maximize) {
    v[u]=1;
...
int main() {
    while(scanf("%d%d%d", &n, &m, &s)!=EOF) {
        ...
        for(int i=0; i<m; i++) {
            ...
            if(t==2) {
                //undirected
                add_edge(u, v, eid+1, r);
                add_edge(v, u, eid-1, r++);
            } else {
                //directed
                add_edge(u, v, -1, -1);
            }
