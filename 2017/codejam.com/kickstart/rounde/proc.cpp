...
int main(){
    ...
    for(int _T=1; _T<=T; _T++){
        ...
        e[0]=sqrt((p[0].x-p[1].x)*1.0*(p[0].x-p[1].x)+(p[0].y-p[1].y)*1.0*(p[0].y-p[1].y)+(p[0].z-p[1].z)*1.0*(p[0].z-p[1].z));
        e[1]=sqrt((p[0].x-p[2].x)*1.0*(p[0].x-p[2].x)+(p[0].y-p[2].y)*1.0*(p[0].y-p[2].y)+(p[0].z-p[2].z)*1.0*(p[0].z-p[2].z));
        e[2]=sqrt((p[1].x-p[2].x)*1.0*(p[1].x-p[2].x)+(p[1].y-p[2].y)*1.0*(p[1].y-p[2].y)+(p[1].z-p[2].z)*1.0*(p[1].z-p[2].z));
        sort(e, e+3);
        printf("%.9f\n", process());
    }
    return 0;
