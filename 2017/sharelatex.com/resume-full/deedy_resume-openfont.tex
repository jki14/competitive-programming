...
\descript{| Team Leader of Algorithm Implementation Team}
...
\runsubsection{Wonder}
\descript{| Team Leader of Backend Team}
\descript{Augmented Reality Entertainment Platform on Mobile}
\location{Hangzhou Tomorning Technology Co., Ltd.}
...
\item Independently optimize Mysql databases performance, make each business service request is able to complete in 10 milliseconds.
\end{tightemize}
\sectionsep
