...
typedef struct objt_s{
	char *nick;
	int idx, wht;
	bool operator < (const objt_s &opn) const{
		if(wht!=opn.wht){
			return wht<opn.wht;
		}
		return idx>opn.idx;
